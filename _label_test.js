...
// SSR 渲染：验证 candlestick label 是否输出涨跌幅文字
const bars = [
...
const hits = ["+5.00%", "-2.86%", "+8.82%", "5.00%", "2.86%", "8.82%"].filter((s) => svg.includes(s));
console.log("SVG 中匹配到的涨跌幅文字:", hits.length ? hits : "无");
console.log("SVG 包含 <text> 元素:", svg.includes("<text"));
